...
namespace Waterfall
{
  ...
  public class EffectParticleMultiNumericIntegrator : EffectIntegrator
  {
    ...
    public override void Update()
    {
      ...
      s_Update.End();
      Debug.Log($"Intupdate End");
    }
    protected override void Apply()
    {
      Debug.Log($"IntApply Start");
      ...
      Debug.Log($"IntApply End");
    }

    public void Integrate(EffectModifierMode mode, MultiNumericData[] items, MultiNumericData[] modifiers)
    {
      Debug.Log($"IntegrateStart");
